...
const newsapi = new NewsAPI("0b3a687275104852a2b8e5c013dbc3b5");
...
module.exports = class NewsCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      args: [
        {
          key: "newsSource",
          prompt: "What news source would you like?",
          type: "string"
        }
      ]
    });
  ...
  async run(msg, args) {
    ...
    if (newsSource === "cnn") {
      source.name = "cnn";
      source.icon =
        "http://vignette3.wikia.nocookie.net/logopedia/images/0/09/CNN_International_logo_2014.svg/revision/latest/scale-to-width-down/185?cb=20161205122246";
    }
    ...
    if (newsSource === "techradar") {
      ...
      source.icon =
        "https://s-media-cache-ak0.pinimg.com/564x/e7/d4/32/e7d43201fc36584e635a299a14823a92.jpg";
    }
    ...
    if (newsSource === "washington-post") {
      ...
      source.icon =
        "https://pbs.twimg.com/profile_images/753656134565785600/iQ1GX-ov.jpg";
    }
    if (newsSource === "buzzfeed") {
      source.name = "buzzfeed";
      source.icon =
        "https://webappstatic.buzzfeed.com/static/images/global/og-image-trending.jpg";
    }
    if (newsSource === "the-verge") {
      source.name = "the-verge";
      source.icon =
        "https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/The_Verge_logo.svg/2000px-The_Verge_logo.svg.png";
    }
    if (newsSource === "time") {
      source.name = "time";
      source.icon =
    ...
    if (newsSource === "daily-mail") {
      ...
      source.icon =
        "http://logos-download.com/wp-content/uploads/2016/06/The_Daily_Mail_logo_wordmark.png";
    }
    if (newsSource === "wsj") {
    ...
    if (newsSource === "nytimes") {
      ...
      source.icon =
        "http://www.goseekadventures.com/wp-content/uploads/2014/06/New-York-Times-Social-Logo.jpg";
    }
    if (newsSource === "google") {
      source.name = "google-news";
      source.icon =
        "https://lh3.googleusercontent.com/fnqDFUD0zN_T1rR-4fyiCGsn6-MVE3azzA6fgMZN5xmsNIvpNQ7NbG0sXNGovftaQhb6=w300";
    }
    if (newsSource === "espn") {
      source.name = "espn";
      source.icon =
        "https://pbs.twimg.com/profile_images/629351437676511232/PnAYQDx8.png";
    }
    ...
    if (newsSource === "mashable") {
      ...
      source.icon =
        "https://yt3.ggpht.com/-QN_50PuVBvA/AAAAAAAAAAI/AAAAAAAAAAA/BTltwiK9xLg/s900-c-k-no-mo-rj-c0xffffff/photo.jpg";
    } else if (newsSource === "national-geographic") {
      source.name = "national-geographic";
      source.icon =
        "http://logok.org/wp-content/uploads/2014/06/National-Geographic-logo.png";
    }
    ...
    embed
      ...
      .addField(
        `\u200b`,
        `**[${res.articles[0]["title"]}](${res.articles[0]["url"]})**`,
        true
      )
      .addField(
        `\u200b`,
        `**[${res.articles[1]["title"]}](${res.articles[1]["url"]})**`,
        true
      )
      .addField(
        `\u200b`,
        `**[${res.articles[2]["title"]}](${res.articles[2]["url"]})**`,
        true
      )
      .addField(
        `\u200b`,
        `**[${res.articles[3]["title"]}](${res.articles[3]["url"]})**`,
        true
      )
      .addField(
        `\u200b`,
        `**[${res.articles[4]["title"]}](${res.articles[4]["url"]})**`,
        true
      )
      .setFooter(`News from newsapi.org`);
    msg.embed(embed);
  }
};
