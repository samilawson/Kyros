...
module.exports = class UpdatesCommand extends Command {
  ...
  async run(msg) {
    ...
    if (msg.member.roles.has(role.id)) {
      msg.member.removeRole(role).catch(e => {
        msg.reply(e);
      });
      msg.reply(
        ":no_entry_sign: You will no longer recieve updates on this server."
      );
      ...
      msg.reply(
        ":white_check_mark: You will now recieve updates on this server."
      );
    }
  }
};
