...
module.exports = class SuggestCommand extends Command {
  ...
  async run(msg, args) {
    ...
    const content = `A suggestion was submitted from **${
    ...
    new Promise((resolve, reject) => {
      superagent
        ...
        .set(
          `Authorization`,
          `Bot MjY0ODUwNTE0OTA5MzMxNDU2.C0mlNw.-fEkhcmlo2QyFvoEisXNGohDrBE`
        )
        .send({ content })
        .end((err, res) => {
          if (err) {
            ...
            resolve(res);
            msg.say(
              "Thank you for your suggestion! If you have any questions please join my server: https://discord.gg/TmQQddz"
            );
          }
        });
    });
